...
echo
echo "# configuration for streamer ftp server"
echo "STREAMER_FTP_USERNAME=$STREAMER_FTP_USERNAME"
echo "STREAMER_FTP_PASSWORD=$STREAMER_FTP_PASSWORD"
echo "STREAMER_FTP_AUTHORIZED_KEYS=$STREAMER_FTP_AUTHORIZED_KEYS"
echo "STREAMER_FTP_UID=$STREAMER_FTP_UID"
echo "STREAMER_FTP_GID=$STREAMER_FTP_GID"
echo "STREAMER_FTP_EXTERNAL_PORT=$STREAMER_FTP_EXTERNAL_PORT"
echo "STREAMER_FTP_HOST_KEY_ED25519=$STREAMER_FTP_HOST_KEY_ED25519"
echo "STREAMER_FTP_HOST_KEY_RSA=$STREAMER_FTP_HOST_KEY_RSA"
echo
