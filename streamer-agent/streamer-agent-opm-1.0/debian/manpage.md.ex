% streamer-agent-opm(SECTION) | User Commands
%
% "October  2 2024"
...
streamer-agent-opm - program to do something

# SYNOPSIS

**streamer-agent-opm** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**streamer-agent-opm** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **streamer-agent-opm** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**streamer-agent-opm** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    streamer-agent-opm. See **foo.conf**(5) for further details.
...
**streamer-agent-opm** provides some return codes, that can be used in scripts:
...
DCCN Technical Group <helpdesk@donders.ru.nl>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 DCCN Technical Group
